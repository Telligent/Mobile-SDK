...
{
	public class IOSApplicationFileViewer : IPlugin, IFileViewer, IPluginGroup, ITranslatablePlugin
	{
		...
		{
			get { return "Enables previewing and installation iOS applications."; }
		}
		...
		public string Name
		{
			get { return "iOS Application File Viewer"; }
		}
		...
		public Translation[] DefaultTranslations
		{
			get
			{
				...
				translation.Set("itunes_install", "View in iTunes");
