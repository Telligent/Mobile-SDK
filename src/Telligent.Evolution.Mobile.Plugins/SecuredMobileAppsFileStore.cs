...
{
	public class SecuredMobileAppsFileStore : IPlugin,  ICentralizedFileStore
	{
		#region IPlugin Members

		public string Description
		{
			get { return "Stores data about private mobile applications."; }
		}
		...
		public string Name
		{
			get { return "Secure Mobile Applications File Store"; }
		}
		...
		{
			get { return Telligent.Evolution.Mobile.App.Model.AppConstants.SecureAppDataFileStoreKey; }
		}
